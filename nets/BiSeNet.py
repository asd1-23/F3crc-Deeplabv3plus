...
class AttentionRefinementModule(torch.nn.Module):
    ...
    def forward(self, input):
        ...
        assert self.in_channels == x.size(1), 'in_channels {} and out_channels {} should all be {}'.format(
            self.in_channels, x.size(1), x.size(1))
        x = self.conv(x)
...
class FeatureFusionModule(torch.nn.Module):
    ...
    def forward(self, input_1, input_2):
        ...
        assert self.in_channels == x.size(1), 'in_channels {} of ConvBlock should be {}'.format(self.in_channels,
                                                                                                x.size(1))
